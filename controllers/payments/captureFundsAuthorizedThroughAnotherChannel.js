...
exports.captureFundsAuthorizedThroughAnotherChannel = (req, res) => {
  var calculateAmount = () => {
    return 1000;
  };
  ...
  transactionRequestType.setTransactionType(
    ApiContracts.TransactionTypeEnum.CAPTUREONLYTRANSACTION
  );
  transactionRequestType.setPayment(paymentType);
  transactionRequestType.setAmount(calculateAmount());
  transactionRequestType.setAuthCode(req.body.authCode); //('ROHNFQ');
